...
module.exports = function() {
  ...
  // [db-inspect] writes app config to db. possibly user data
   ...
   *
   */
  // [db-inspect] writes app config to db. user data?
   ...
   *
   */
  // [db-inspect] creates the app config. user data?
   ...
   *
   */
  // [db-inspect] reads app config from db - user data
   ...
   *
   */
  // [db-inspect] delete app config from db. user data
